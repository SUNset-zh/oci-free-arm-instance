...
POST = dict(exposure_keys=[[1, .3], [60, .2], [194, 0.0]], h_dens=1.2e-5, h_base=4500, h_scale=1500, dist_fog=110000,
            ...
            cloudsea=dict(base=5150, a1=220, s1=9000, a2=260, s2=2400, wind=(35, 12), mist=160, sun_gain=.9, sun_k=1.0,
                          amb=.9, amb_rgb=(.07, .09, .13), silver=2.2, wrap=.5, soft=1.2, fog_top=40, fog_depth=220),
